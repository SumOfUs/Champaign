...
<a href=\"#{Settings.home_page_url}/email_confirmation+imarealtoken1235\">link</a>\
, or copy paste this URL to your browser: #{Settings.home_page_url}/\
email_confirmation+imarealtoken1235 </p></body></html>")
    end
 ...
 address: #{Settings.home_page_url}/email_confirmation+imarealtoken1235' ")
    end
  end
end
