...
describe ClonePagesController do
  ...
  describe 'POST #create' do
    ...
    before do
      ...
      post :create, params: { id: '1', page: { title: 'foo', language_id: 3 },
                              override_forms: '1', exclude_shares: '0' }
    end
    ...
    it 'clones page' do
      expect(PageCloner).to have_received(:clone).with(page, 'foo', '3', true, false)
    end
