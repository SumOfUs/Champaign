...
describe ChampaignQueue::Clients::Sqs do
  context 'with SQS_QUEUE_URL' do
    ...
    let(:request_body) { 'Action=SendMessage&MessageBody=%7B%22foo%22%3A%22bar%22%7D&MessageGroupId=abc&QueueUrl=https%3A%2F%2Fsqs.us-east-1.amazonaws.com%2F679051310897%2Fdemo&Version=2012-11-05' }
