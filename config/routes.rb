...
Rails.application.routes.draw do
  ...
  post 'eoy_donations/opt_out.:format', to: 'eoy_donations#opt_out'
  post 'eoy_donations/opt_in.:format', to: 'eoy_donations#opt_in'
  ...
  resources :pages, path: ':locale/a/', as: 'member_facing_page', only: %i[show], constraints: { locale: /en|fr|de|es|pt|nl|ar/ } do
    get 'follow-up', on: :member, action: 'follow_up'
  end
  ...
  namespace :api do
    ...
    get 'members/set_payment_methods', to: 'members#set_payment_methods'
