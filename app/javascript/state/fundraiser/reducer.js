...
function supportedCurrency(
  ...
  const list = _.isEmpty(supportedCurrencies)
    ? Object.keys(initialState.donationBands)
    : supportedCurrencies;
...
export default function fundraiserReducer(
  state: Fundraiser = initialState,
  ...
  switch (action.type) {
    case "parse_champaign_data":
      ...
      const amounts = _.isEmpty(donationBands)
        ? state.donationBands
        : donationBands;
      ...
      return Object.assign({}, state, fundraiser, {
        ...
        donationFeaturedAmount: fundraiser.preselectAmount
          ? pickMedianAmount(amounts, currency)
          : undefined,
        recurring:
          recurringDefault === "recurring" ||
            recurringDefault === "only_recurring"
      });
    case "reset_member":
    ...
    case "change_currency":
      return Object.assign({}, state, {
        ...
        donationFeaturedAmount: state.preselectAmount
          ? pickMedianAmount(state.donationBands, action.payload)
          : undefined
      });
    case "change_amount":
      return Object.assign({}, state, {
